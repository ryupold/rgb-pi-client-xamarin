...
//		private static readonly string STATE_ORIENTATION = "orientation";
	 ...
	 */
		...
		private const float CORNER_RADIUS_DEFAULT = 20f;
	 ...
	 */
		...
		protected override void OnSizeChanged (int w, int h, int oldw, int oldh)
		{
			...
			if (!IsInEditMode) {
				...
				shader = new LinearGradient (mBarPointerHaloRadius, 0,
					x1, y1, new int[] {
					unchecked((int)0xffffffff), unchecked((int)0xff81ff00), unchecked((int)0xff000000)
				}, null,
		...
		{
			// Draw the bar.
			canvas.DrawRoundRect (mBarRect, mCornerRadius, mCornerRadius, mBarPaint);
