 ...
 */
	 ...
	 */
		...
		/// <summary>
		/// This event is called whenever a new color has been selected.
		/// Currently it is always called when the color wheel has been released.
		/// </summary>
		public EventHandler<int> ColorSelected;

		/// <summary>
		/// this is called when the old color is changed while the user touches the color wheel
		/// </summary>
		public EventHandler<int> ColorChanged;
	 ...
	 */
		private float colorToAngle (int color)
		{
			...
			Color.ColorToHSV (new Color (color), colors);
	 ...
	 */
		public void setNewCenterColor (int color)
		{
			...
			mCenterNewPaint.Color = new Color (color);
			if (mCenterOldColor == 0) {
				mCenterOldColor = color;
				mCenterOldPaint.Color = new Color (color);
			}
			if (ColorChanged != null && color != oldChangedListenerColor) {
